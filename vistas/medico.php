                    ...
                    <div class="panel-body" id="formularioregistros">
                        <form name="formulario" id="formulario" method="POST">
                          ...
                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            ...
                            <input type="email" class="form-control" name="email" id="email" maxlength="50" placeholder="N° Matrícula">
                          </div>

                          <div class="form-group col-lg-6 col-md-6 col-sm-6 col-xs-12">
                            <label>Especialidad(*):</label>
                            <select class="form-control select-picker" name="turno" id="turno" required>
                            <option value="TARDE">Médico General</option>
                              <option value="mañana">Pediatra</option>
                              <option value="TARDE">Odontología</option>
                              <option value="TARDE">Ginecología</option>
